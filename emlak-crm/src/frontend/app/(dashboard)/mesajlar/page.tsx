...
const mockConversations: Conversation[] = [
  {
    ...
    messages: [
      {
        id: "m1",
        text: "Merhaba, Kadikoy 3+1 daire hala satilik mi?",
        time: "09:15",
        sent: false,
        read: true,
      },
      {
        id: "m2",
        text: "Merhaba Ahmet Bey, evet ilan hala aktif. Size detaylari paylasayim.",
        time: "09:20",
        sent: true,
        read: true,
      },
      {
        id: "m3",
        text: "Daire 145 m2, 3+1, 5. katta. Fiyati 4.500.000 TL.",
        time: "09:21",
        sent: true,
        read: true,
      },
      {
        id: "m4",
        text: "Tesekkur ederim, yerinde gormek istiyorum.",
        time: "09:45",
        sent: false,
        read: true,
      },
      {
        id: "m5",
        text: "Tabii, size uygun bir zaman belirleyelim. Yarin ogleden sonra musait misiniz?",
        time: "09:50",
        sent: true,
        read: true,
      },
      {
        id: "m6",
        text: "Kadikoy daire icin yarin musait miyim?",
        time: "10:35",
        sent: false,
        read: false,
      },
  ...
  },
  {
    ...
    messages: [
      {
        id: "m7",
        text: "Merhaba, Atasehir 2+1 kiralik daire icin bilgi alabilir miyim?",
        time: "14:00",
        sent: false,
        read: true,
      },
      {
        id: "m8",
        text: "Merhaba Fatma Hanim, tabi. Kira bedeli aylik 25.000 TL, aidat 2.000 TL.",
        time: "14:15",
        sent: true,
        read: true,
      },
  ...
  },
  {
    ...
    messages: [
      {
        id: "m10",
        text: "Besiktas villa gosterimi icin saat 14:00 uygun.",
        time: "11:00",
        sent: false,
        read: false,
      },
  ...
  },
  {
    ...
    messages: [
      {
        id: "m11",
        text: "Bakirkoy dublex icin teklifimi ilettim, lutfen inceleyin.",
        time: "16:00",
        sent: false,
        read: true,
      },
      {
        id: "m12",
        text: "Tesekkurler Zeynep Hanim, teklifinizi ev sahibine ilettim. En kisa surede donus yaparim.",
        time: "16:30",
        sent: true,
        read: true,
      },
  ...
  },
  {
    ...
    messages: [
      {
        id: "m13",
        text: "Ilanin goruntulenme sayisi nasil gidiyor?",
        time: "10:00",
        sent: false,
        read: true,
      },
      {
        id: "m14",
        text: "Ali Bey, ilaniniz simdilik 78 kez goruntulendi. 3 adet soru geldi.",
        time: "10:15",
        sent: true,
        read: true,
      },

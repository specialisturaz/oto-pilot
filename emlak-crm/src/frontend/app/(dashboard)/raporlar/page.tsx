    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex gap-2">
          <div className="relative">
            <Button
              variant="outline"
              onMouseEnter={() => setExportTooltip("pdf")}
            ...
            {exportTooltip === "pdf" && (
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 rounded bg-foreground px-2 py-1 text-xs text-background whitespace-nowrap">
                Yakinda
              </div>
            )}
          </div>
          <div className="relative">
            <Button
              variant="outline"
              onMouseEnter={() => setExportTooltip("excel")}
              onMouseLeave={() => setExportTooltip(null)}
            >
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatsCard
          ...
          value={formatPrice(1745000)}
          change="+22% gecen aya gore"
          changeType="positive"
          icon={DollarSign}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Asamalara gore musteri donusum sureci
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Danismanlarin satis performans metrikleri
          </CardDescription>
        </CardHeader>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 hidden md:table-cell">
                      <span className="text-sm">
                        {formatPriceShort(agent.revenue)}
                      </span>
                    </td>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Goruntulenme ve favorilere gore siralama
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Portallara gore detayli metrikler
            </CardDescription>
          </CardHeader>
          <CardContent className="p-0">
            <div className="overflow-x-auto">
                ...
                <tbody className="divide-y">
                  {portalPerformance.map((portal) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className="text-sm">
                          {portal.goruntulenme.toLocaleString("tr-TR")}
                        </span>
                      </td>
                      <td className="px-4 py-3">
                        <span className="text-sm">{portal.talep}</span>
                      </td>
                      <td className="px-4 py-3">
                        <Badge variant="success">{portal.donusum}</Badge>
                      </td>
                    </tr>
                  ))}
                </tbody>
